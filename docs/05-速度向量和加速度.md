...
if (canvas) {
  ...
  if (context) {
    const drawFrame = (time: number) => {
      ...
      // context.clearRect(0, 0, canvas.width, canvas.height)
      ball.x = v0x * timeInSeconds + (1 / 2) * ax * timeInSeconds ** timeInSeconds + x0
...
![](https://gw.alicdn.com/imgextra/i3/O1CN01XNGcLP1w9sRR82IFQ_!!6000000006266-1-tps-386-617.gif)

demo 链接 [https://gaohaoyang.github.io/canvas-practice/20-accelerate/](https://gaohaoyang.github.io/canvas-practice/20-accelerate/)

源码链接 [https://github.com/Gaohaoyang/canvas-practice/blob/main/src/20-accelerate/index.ts](https://github.com/Gaohaoyang/canvas-practice/blob/main/src/20-accelerate/index.ts)
